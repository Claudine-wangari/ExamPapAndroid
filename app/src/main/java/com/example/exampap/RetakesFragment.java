...
public class RetakesFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_retakes, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        Call<List<UnitItem>> call = dataService.getRetakeUnits();
